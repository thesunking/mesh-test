...
ContactSys::ContactSys(unsigned int number_of_contacts,
                       std::vector<std::vector<float>> arg_matA,
                       std::vector<float> arg_b)
{
...
void ContactSys::debugPrint()
{
	...
	printf("d: %i   j: %i   s: %f\n", d, j, s);
	printf("st: ");
	for (unsigned int i = 0; i != n; ++i) { printf("%i, ", set[i]); }
	printf("\n");

	printf(" f: ");
	for (unsigned int i = 0; i != n; ++i) { printf("%f, ", f[i]); }
	printf("\n");

	printf("df: ");
	for (unsigned int i = 0; i != n; ++i) { printf("%f, ", df[i]); }
	printf("\n");

	printf(" a: ");
	for (unsigned int i = 0; i != n; ++i) { printf("%f, ", a[i]); }
	printf("\n");

	printf("da: ");
	for (unsigned int i = 0; i != n; ++i) { printf("%f, ", da[i]); }
	printf("\n");
